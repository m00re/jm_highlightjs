...
# TYPO3 extension sphinx on Sun, 03 Apr 2016 16:56:00 +0200.
#
...
htmlhelp_basename = 'jm_highlightjsdoc'
...
latex_documents = [
    ('Index', 'jm_highlightjs.tex', u'Highlight.js',
     u'Jens Mittag', 'manual'),
]
...
pdf_documents = [
    ('Index', 'jm_highlightjs', u'Highlight.js',
     u'Jens Mittag'),
]
...
texinfo_documents = [
    ('Index', 'jm_highlightjs', u'Highlight.js',
     u'Jens Mittag', 'Highlight.js', 'One line description of project.',
     'Miscellaneous'),
]
